...
这份表用于 OpenUsageCN 第一阶段基础中文化。App 本体里的主要用户界面应优先使用这里的中文说法；插件输出、品牌名、命令、环境变量、文件路径、API 名称、GitHub 原文和键盘按键名可以保留英文。
...
- 设置页服务商配置状态用“已配置 / 使用默认 / 未配置”，只描述 OpenUsageCN 当前能判断的配置状态。
