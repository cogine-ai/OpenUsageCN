...
This plugin is separate from OpenCode Go. OpenCode reads the web dashboard subscription usage; OpenCode Go reads account quotas from its official usage API.
