...
Access tokens have a 7-day lifetime. Refreshed when within 24 hours of expiry or on 401/403. If the droid auth file changes while OpenUsageCN is refreshing, it refuses to overwrite the newer credentials.
