...
Returns remote CLI settings. OpenUsageCN reads `subscription_tier_display` from this response and shows it as the provider plan label, for example `SuperGrok Heavy`.
